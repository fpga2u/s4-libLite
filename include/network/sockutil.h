...
public:
     ...
     * @return 0代表成功，-1为失败
     */
    static int setCloseWait(int sock, u_short second = 0);
     ...
     * @return 0代表成功，-1为失败
     */
    static int addRouteViaIP(const char* strAddr, const char* strLocalIp, const char* strMask = "255.255.255.255");
     ...
     * @return 0代表成功，-1为失败
     */
    static int addRouteViaNIC(const char* strAddr, const char* ifrName, const char* strMask = "255.255.255.255");
     ...
     * @return 0代表成功，-1为失败
     */
    static int delRouteViaIP(const char* strAddr, const char* strLocalIp, const char* strMask = "255.255.255.255");
     ...
     * @return 0代表成功，-1为失败
     */
    static int delRouteViaNIC(const char* strAddr, const char* ifrName, const char* strMask = "255.255.255.255");
    ...
    /**
     * 获取网卡列表
     * @return std::vector<std::map<ip:name> >
     */
